  ...
  methods: {
    goToSite(){
      if(this.headline === 'createMovie'){
        this.$store.state.currentMovie = new Movie(this.$store.getters.getNextMovieId, this.$store.state.studio, 0,'Pre Production',75,undefined,undefined,undefined,undefined,undefined,undefined,undefined,undefined,undefined,undefined, undefined, undefined,undefined,undefined,undefined,undefined);
