...
import ProductionTest from '@/classes/test/productionTest'
import store from "@/services/store";
import DataUtil from "@/classes/DataUtil";
import ReleaseTest from "@/classes/test/releaseTest";
...
export class MovieTest {
    constructor(owner, contract) {
        ...
        this._production = new ProductionTest(this._preProduction.releaseDate, this._preProduction.productionLength)
        ...
        this._release = new ReleaseTest(this._preProduction, this.crewMorale, this.genrePopularity,
